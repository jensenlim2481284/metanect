...
<title>Metanect - Merchant Onboarding</title>
                    ...
                    <div class='startup-component'>
                        ...
                        <div>
                            ...
                            <div class="web-co">
                                ...
                                <p class="web-co-link">.metanect.co</p>
                            </div>
            ...
            <div class='startup-content-box '>
                <div class='startup-content question-content'>
                    <div class='startup-component'>
                        ...
                        <p> Let's get started to grow your business and move on to MetaNect. </p>
                    </div>
                    <div class='startup-footer'>
                        <button class='btn btn-secondary  startup-prev ' type='button'>Prev </button>
...
<script type="text/javascript" src="/js/page/merchant/onboarding.js{{ config('app.link_version') }}"></script>
