    ...
    <div class='topnav-section'>
        ...
        <div class='topnav-button'>
            <div class='top-notification-section'>
                <a href='/account/credit' class='mobile-hide'><button class='btn btn-link tour-db point-icon' id="pointIcon" data-element data-index='3' data-intro="This is the amount of Metanect merchant credit you have."><span>500</span><img src='/img/icon/coin.png' /></button></a>
            ...
            data-intro="You can manage your profile or access to account settings here." src='/img/icon/profile.png' />
                ...
                <div class='topnav-profile'>
                    ...
                    <div class='profile-item'>
                        ...
                        <a href='#partner' class='under-development' data-title='Partnership' data-desc='This feature allows merchants to become part of the Metanect community. It acts like a "Master Merchant" inviting merchants, and can earn permanent commissions from the successful transactions of registered merchants.'>
