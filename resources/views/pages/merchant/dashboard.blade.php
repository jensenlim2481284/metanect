...
<title>Metanect - Merchant Dashboard</title>
...
<div class='row'>
    ...
    <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7'>
        <div class='ref-box'>
            <h1>Grow your business with Metanect </h1>
            <p>Sell and manage e-commerce business with merchants on Metanect platform </p>
        ...
        <div class="dashboard-view-list">
            <div class='dashboard-list active'>
                ...
                <div class='list-action'>
                    <a href='#' class='under-development' data-title='Credit Withdrawal' data-desc='This feature allows merchants to submit credit withdrawal requests. Metanect will take one to three business days to process the request'> Withdraw </a>
                </div>
            </div>
...
<script type="text/javascript" src="/js/page/merchant/dashboard.js{{ config('app.link_version') }}"></script>
