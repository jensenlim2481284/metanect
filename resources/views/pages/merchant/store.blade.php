...
<title>Metanect - Store Management</title>
...
<div class='row'>
    @include('component.panel',['data'=>[
        ...
        [
            ...
            'desc' => 'This feature allows merchants to customize their website page design, drag and drop page blocks and select preset templates from the Metanect library',
