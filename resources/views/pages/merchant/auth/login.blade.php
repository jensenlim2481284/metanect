...
@section('head')
<title>Metanect - Merchant Login</title>
...
<div class='login-box row'>
    <div class='logo-section'>
        <div class='logo'>
            <img src="/img/logo/logo.png" /> Metanect.
        </div>
    </div>
    <div class='col-sm-7'>
...
<script type="text/javascript" src="/js/page/merchant/login.js{{ config('app.link_version') }}"></script>
