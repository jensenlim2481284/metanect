...
<title> Metanect - Data Analysis </title>
...
<div class="mobile-drag-scroll first-content">
    ...
    <div class='row info-row mobile-drag-content mb-5 mt-2'>
        @php($reportItem = ['Metanect','Order','Customer','Product','Promotion', 'Store'])
    ...
    <div class='row'>
        <div class='col-sm-12'>
            <div class="alert alert-info" role="alert">
                <i class='ti-info-alt'></i>  The following Metanect network data analysis is based on <b>Beauty industry</b>            
            </div>
        </div>
        <div class='col-sm-4'>
