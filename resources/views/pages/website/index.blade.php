    ...
    <div class="content">
        <div id='contentSection'>
            ...
            <div id='buttonSection'>
                <a href='{{env("MERCHANT_URL")}}'><button class='btn btn-primary nav-btn hover start-btn' type='button'> <i class="ti ti-heart"></i><span> Get Started</span></button></a>
                <a href='https://github.com/jensenlim2481284/metanect'><button class='btn btn-primary nav-btn about-btn' type='button'> <i class="ti ti-face-smile"></i><span> About </span></button></a>
            </div>
        </div>
    </div>
